...
<section class="min-h-screen py-24 px-6 md:px-12 flex flex-col justify-center items-center relative">
      ...
      <div class="w-full max-w-md mx-auto my-8 relative group">
        ...
        <div class="bg-black/30 backdrop-blur-md border border-accent/20 rounded-xl p-1.5 grid grid-cols-3 gap-1 shadow-lg shadow-accent/5 transition-all duration-500 group-hover:border-accent/30">
          <button 
            ...
            aria-pressed={selectedTab === 'stories'}
          >
          ...
          <button 
            ...
            class="py-3 px-4 text-center rounded-lg transition-all duration-300 font-handwriting relative overflow-hidden {selectedTab === 'journal' 
              ? 'bg-gradient-to-br from-black/80 to-black/60 text-accent font-bold shadow-inner' 
              : 'text-white hover:text-accent hover:bg-black/40'}"
            aria-pressed={selectedTab === 'journal'}
          >
          ...
          <button 
            ...
            class="py-3 px-4 text-center rounded-lg transition-all duration-300 font-handwriting relative overflow-hidden {selectedTab === 'about' 
              ? 'bg-gradient-to-br from-black/80 to-black/60 text-accent font-bold shadow-inner' 
              : 'text-white hover:text-accent hover:bg-black/40'}"
            aria-pressed={selectedTab === 'about'}
          >
  ...
  <div class="absolute inset-0 z-0">
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[30rem] h-[30rem] rounded-full filter blur-3xl bg-accent/5"></div>
  </div>
</section> 